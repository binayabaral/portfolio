<template>
	<header id="header">
		<div class="container">
			...
			<a href="#" class="nav-opener" @click="toggleNav" :class="{ 'nav-active': navExpanded }"><span></span></a>
...
export default {
	data: () => ({
		navLinks: [{ to: '/about', linkName: 'About' }, { to: '/projects', linkName: 'Projects' }, { to: '/blog', linkName: 'Blogs' }, { to: '/contact', linkName: 'Contact' }],
		navExpanded: false,
	}),
	mounted() {
